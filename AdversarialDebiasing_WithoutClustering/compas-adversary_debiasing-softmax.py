...
display_freq = 1000
learning_rate = 1e-4
# alpha = 0.0             # alpha set to 0 for without adversary case
alpha = 0.006         # alpha set to non-0 for with adversary case
# alpha2 = 0.0            # alpha set to 0 for without adversary case
alpha2 = 0.006        # alpha set to non-0 for with adversary case
K = 10
# threshold = 0.0         # used when alpha set to 0 - tuned threshold for optimum accuracy/fairness
threshold = -0.1      # used when alpha is non zero
threshold_adv2 = 0.0
